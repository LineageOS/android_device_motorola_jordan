...
set_scaling()
{
  case "$scaling" in
    ...
    "5" )
      ...
      echo $smt_min_cpu_load > /sys/devices/system/cpu/cpufreq/smartass/min_cpu_load
      echo $smt_max_cpu_load > /sys/devices/system/cpu/cpufreq/smartass/max_cpu_load
      echo $smt_awake_min_freq > /sys/devices/system/cpu/cpufreq/smartass/awake_min_freq
      echo $smt_sleep_max_freq > /sys/devices/system/cpu/cpufreq/smartass/sleep_max_freq
      echo $smt_up_min_freq > /sys/devices/system/cpu/cpufreq/smartass/up_min_freq
      echo $smt_wakeup_freq > /sys/devices/system/cpu/cpufreq/smartass/sleep_wakeup_freq
      echo $smt_ramp_up_step > /sys/devices/system/cpu/cpufreq/smartass/ramp_up_step
    ;;
    "6" )
      if [ $load_all -eq 0 ]; then
